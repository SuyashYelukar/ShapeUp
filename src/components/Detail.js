...
const Detail = ({ exerciseDetail }) => {
  ...
  return (
     <Stack gap="60px" sx={{  marginLeft:'150px',flexDirection: { lg: 'row' }, p: '20px', alignItems: 'center' }}>
      <img src={gifUrl} alt={name}  className="detail-image" />
      <Stack sx={{ marginTop:'30px',marginLeft:'30px',gap: { lg: '35px', xs: '20px' }}}>
        <Typography sx={{ fontSize: { lg: '62px', xs: '30px' } }} fontWeight={700} textTransform="capitalize">
          {name}
        </Typography>
