    ...
    <Stack alignItems="center" mt="37px" justifyContent="center" p="20px">
      ...
      <Box position="relative" mb="72px">
        <TextField
          ...
          type="text"
        />
        <Button className="search-btn" sx={{bgcolor: '#FF2625', color: '#fff', textTransform: 'none', width: { lg: '170px', xs: '80px' }, height: '56px', position: 'absolute',  fontSize: { lg: '20px', xs: '14px' },ml:{lg:'5px'} }} onClick={handleSearch}>
          Search
        </Button>
      </Box>
